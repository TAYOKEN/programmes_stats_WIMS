...
class App:
    def __init__(self, master):
        self.master = master
        master.title("Calculateur de Médiane et Quartiles")
    ...
    def calculate(self):
        ...
        positions = [total * p for p in (0.25, 0.5, 0.75)]
        ...
        q1_classe = trouver_classe(positions[0])
        med_classe = trouver_classe(positions[1])
        q3_classe = trouver_classe(positions[2])
